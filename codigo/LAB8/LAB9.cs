...
namespace LAB9{
    public static class copiar{
        public static void FilaInversa(int[] fila1, int[] fila2, ref int referencia){
        ...
        public static void Pilha(int[] pilha1, int[] pilha2, ref int referencia){
            ...
            for(int j = 0; j < refPilhaAux; j += 0){
                int valor = LAB8.pilha.remover(pilhaAux, ref refPilhaAux);
